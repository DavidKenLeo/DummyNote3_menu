...
public class DB {
    ...
    private static final String KEY_CREATED = "市";
    private static final String KEY_a = "區";
    private static final String KEY_C = "地址";
    private static final String KEY_D = "電話";
    private static final String KEY_e = "診療科別";

    String[] strCols = {KEY_ROWID, KEY_NOTE, KEY_CREATED,KEY_a,KEY_C,KEY_D,KEY_e};
